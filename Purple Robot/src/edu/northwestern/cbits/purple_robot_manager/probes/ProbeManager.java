...
public class ProbeManager
{
    ...
    public static PreferenceScreen buildPreferenceScreen(Context context, PreferenceManager manager)
    {
        ...
        enabled.setDefaultValue(ProbeManager.DEFAULT_STATE);
        enabled.setChecked(ProbeManager.DEFAULT_STATE);
        ...
        {
            if (!probeCategories.contains(key))
    ...
    public static boolean probesState(Context context)
    {
        ...
        return prefs.getBoolean("config_probes_enabled", true);
    }
